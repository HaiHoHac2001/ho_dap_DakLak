...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [106.266272, 11.682666, 110.175321, 13.652904], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [107.484589, 12.160666, 108.995407, 13.416485],
            units: 'degrees'})
    })
});
...
map.getView().fit([106.266272, 11.682666, 110.175321, 13.652904], map.getSize());
